...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data", action="store", default="/Datadisk/datasets/CIFAR10", help="dataset path"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--refine",
        default="/home/zhangsiyu/micronet/micronet/compression/pruning/models_save/nin_gc.pth",
        # default="/home/zhangsiyu/micronet/micronet/compression/quantization/wqaq/iao/models_save/nin_gc_bn_fused.pth",
        # default="/home/zhangsiyu/micronet/micronet/compression/quantization/wqaq/dorefa/models_save/nin_gc.pth",
        type=str,
        metavar="PATH",
    ...
    # bn融合标志位
    parser.add_argument(
        "--bn_fuse", action="store_false", help="batch-normalization fuse" #false
    )
    # bn融合校准标志位
    parser.add_argument(
        "--bn_fuse_calib",
    ...
    # ptq_batch
    parser.add_argument("--ptq_batch", type=int, default=200, help="the batch of ptq")
    parser.add_argument(
