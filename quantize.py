...
from model_quantize import Add
...
class QuantDeformConvPack_d(DeformConvPack_d):
    ...
    def forward(self, input, ):
        ...
        if not self.quant_inference:
            quant_weight = self.weight_quantizer(self.weight)
            quant_offset_weight = self.conv_offset.weight_quantizer(self.conv_offset.weight)
        else:
            quant_weight = self.weight
        ...
        if self.conv_offset.bias is not None:
            quant_offset_bias = self.conv_offset.bias_quantizer(self.conv_offset.bias)
        else:
